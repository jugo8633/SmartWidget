...
public class CalendarWidget extends RelativeLayout
{
	...
	private void init(Context context)
	{
		...
		LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, 0, 0.1f);
		LinearLayout.LayoutParams params2 = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, 0, 1.0f);
		LinearLayout.LayoutParams params3 = new LinearLayout.LayoutParams(0, LayoutParams.MATCH_PARENT, 1.0f);
		LinearLayout.LayoutParams params4 = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, 0, 0.08f);
		...
		ivArrowRight.setLayoutParams(new LayoutParams(60, LayoutParams.MATCH_PARENT));
		...
		ivCalendarDays.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));
